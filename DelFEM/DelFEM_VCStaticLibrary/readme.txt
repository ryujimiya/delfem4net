...
DelFEM is written in C++, so probably you can compile it with many different C++ compilers. But I recommend you to use gcc with which I usually compile this library. 

GLUT system is also a requirement for building this library.
