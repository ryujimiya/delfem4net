...
public:     
  ...
  virtual bool GetColor_Edge(unsigned int id_e, double color[3]) const; // added by ryujimiya
  virtual bool SetColor_Edge(unsigned int id_e, const double color[3]); // added by ryujimiya
  ...
  virtual bool GetColor_Vertex(unsigned int id_v, double color[3]) const; // added by ryujimiya
  virtual bool SetColor_Vertex(unsigned int id_v, const double color[3]); // added by ryujimiya
