...
#if !defined(DELFEM4NET_MESH_KERNEL_3D_H)
#define DELFEM4NET_MESH_KERNEL_3D_H
...
#include "DelFEM4Net/msh/meshkernel2d.h"    // SBarを参照するためだけにinclude。本当はSBarの定義をここ以外に移したほうが良い。
...
//! ３次元の点クラス
public ref class CPoint3D
{
public:
    CPoint3D ()
    {
       this->self = new Msh::CPoint3D();
    }
    
    CPoint3D(const CPoint3D% rhs)
    {
        Msh::CPoint3D rhs_instance_ = *(rhs.self);
        this->self = new Msh::CPoint3D(rhs_instance_);
    }
    
    CPoint3D(double x, double y, double z)
    {
       this->self = new Msh::CPoint3D(x, y, z);
    }

    CPoint3D(Msh::CPoint3D *self)
    {
        this->self = self;
    }
    ...
    bool operator < (CPoint3D^ rhs)
    {
        bool ret = this->self->operator < (*(rhs->self));
        
        return ret;
    }
    
public:
    property Msh::CPoint3D * Self
    {
        Msh::CPoint3D *get() { return this->self; }
    }

    property DelFEM4NetCom::CVector3D^ p 
    {
        DelFEM4NetCom::CVector3D^ get()
        {
            const Com::CVector3D& unmanaged_instance = this->self->p;
    ...
    property unsigned int poel     //!< 要素のどの節点に接しているか
    {
        unsigned int get() { return this->self->poel ; }
        void set(unsigned int value) { this->self->poel = value; }
    }

    property int old_p               //!< 変更前の節点番号
    {
        int get() { return this->self->old_p ; }
        void set(int value) { this->self->old_p = value; }
    }
...
public:
    ...
    STet ()
    {
       this->self = new Msh::STet;
    }
    
    STet(const STet% rhs)
    {
        Msh::STet rhs_instance_ = *(rhs.self);
        this->self = new Msh::STet(rhs_instance_);
    }
...
public:
    property Msh::STet * Self
    {
        Msh::STet *get() { return this->self; }
    }

    property array<unsigned int>^ v  //<! 頂点のIndex v[4]
    {
    ...
    property array<unsigned int>^ s  //<! 隣接要素のIndex s[4]
    {
        array<unsigned int>^ get()
        {
            unsigned int* unmanaged = this->self->s;
    ...
    property array<int>^ g  //g[4]
    {
        array<int>^ get()
        {
            int* unmanaged = this->self->g;
    ...
    property array<unsigned int>^ f  //f[4]
    {
        array<unsigned int>^ get()
        {
            unsigned int* unmanaged = this->self->f;
            array<unsigned int>^ managed = gcnew array<unsigned int>(C_S_CNT);
            for (int i = 0; i < C_S_CNT; i++)
            {
                managed[i] = unmanaged[i];
    ...
    property int old_t
    {
        int get() { return this->self->old_t; }
        void set(int value) { this->self->old_t = value; }
    }
...
*/
public ref class SHex
{
public:
    static int C_V_CNT = 8;  // 頂点数
    static int C_S_CNT = 6;  // 隣接要素数

    SHex ()
    {
       this->self = new Msh::SHex;
    }
    
    SHex(const SHex% rhs)
    {
        Msh::SHex rhs_instance_ = *(rhs.self);
        this->self = new Msh::SHex(rhs_instance_);
    }
...
public:
    property Msh::SHex * Self
    {
        Msh::SHex *get() { return this->self; }
    }

    property array<unsigned int>^ v  //<! 頂点のIndex v[8]
    {
        array<unsigned int>^ get()
        {
            unsigned int* unmanaged = this->self->v;
    ...
    property array<unsigned int>^ s  //<! 隣接要素のIndex s[6]
    {
        array<unsigned int>^ get()
        {
            unsigned int* unmanaged = this->self->s;
    ...
    property array<unsigned int>^ f  //f[6]
    {
        array<unsigned int>^ get()
        {
            unsigned int* unmanaged = this->self->f;
    ...
    property int old_h
    {
        int get() { return this->self->old_h; }
        void set(int value) { this->self->old_h = value; }
    }
...
*/
public ref class STri3D
{
public:
    static int C_V_CNT = 3;  // 頂点数
    static int C_S_CNT = 3;  // 隣接要素数
    static int C_F_CNT = 2;  // 隣接要素数

    STri3D ()
    {
       this->self = new Msh::STri3D;
    }
    
    STri3D(const STri3D% rhs)
    {
        Msh::STri3D rhs_instance_ = *(rhs.self);
        this->self = new Msh::STri3D(rhs_instance_);
    }
    
    STri3D(Msh::STri3D *self)
    {
        this->self = self;
    }
...
public:
    property Msh::STri3D * Self
    {
        Msh::STri3D *get() { return this->self; }
    }

    property array<unsigned int>^ v  //<! 頂点のIndex v[3]
    {
        array<unsigned int>^ get()
        {
            unsigned int* unmanaged = this->self->v;
    ...
    property array<unsigned int>^ s2  //<! 隣接要素のIndex s2[3]
    {
        array<unsigned int>^ get()
        {
    ...
    property array<unsigned int>^ r2  //r2[3]
    {
        array<unsigned int>^ get()
        {
    ...
    property array<int>^ sf  //sf[2]
    {
        array<int>^ get()
        {
            int* unmanaged = this->self->sf;
            array<int>^ managed = gcnew array<int>(C_F_CNT);
            for (int i = 0; i < C_F_CNT; i++)
            {
                managed[i] = unmanaged[i];
            }
            return managed;
    ...
    property array<int>^ gf  //gf[2]
    {
        array<int>^ get()
        {
            int* unmanaged = this->self->gf;
            array<int>^ managed = gcnew array<int>(C_F_CNT);
            for (int i = 0; i < C_F_CNT; i++)
            {
                managed[i] = unmanaged[i];
    ...
    property array<unsigned int>^ df  //df[2]
    {
        array<unsigned int>^ get()
        {
            unsigned int* unmanaged = this->self->df;
            array<unsigned int>^ managed = gcnew array<unsigned int>(C_F_CNT);
            for (int i = 0; i < C_F_CNT; i++)
            {
                managed[i] = unmanaged[i];
            }
...
public:
    ...
    SQuad3D ()
    {
       this->self = new Msh::SQuad3D;
    }
    
    SQuad3D(const SQuad3D% rhs)
    {
        Msh::SQuad3D rhs_instance_ = *(rhs.self);
        this->self = new Msh::SQuad3D(rhs_instance_);
    }
    
    SQuad3D(Msh::SQuad3D *self)
    {
        this->self = self;
    }
...
public:
    property Msh::SQuad3D * Self
    {
        Msh::SQuad3D *get() { return this->self; }
    }
    ...
    property array< int>^ se  //<! 隣接要素のIndex se[4]
    {
        array< int>^ get()
        {
             int* unmanaged = this->self->se;
            array< int>^ managed = gcnew array< int>(C_S_CNT);
            for (int i = 0; i < C_S_CNT; i++)
            {
                managed[i] = unmanaged[i];
    ...
    property array<int>^ ge  //ge[4]
    {
        array<int>^ get()
        {
            int* unmanaged = this->self->ge;
            array<int>^ managed = gcnew array<int>(C_S_CNT);
            for (int i = 0; i < C_S_CNT; i++)
            {
                managed[i] = unmanaged[i];
    ...
    property array<unsigned int>^ de  //de[4]
    {
        array<unsigned int>^ get()
        {
            unsigned int* unmanaged = this->self->de;
            array<unsigned int>^ managed = gcnew array<unsigned int>(C_S_CNT);
            for (int i = 0; i < C_S_CNT; i++)
            {
                managed[i] = unmanaged[i];
