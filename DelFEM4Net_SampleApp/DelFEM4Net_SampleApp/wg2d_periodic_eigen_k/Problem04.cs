...
namespace wg2d_periodic_eigen_k
{
    class Problem04
    {
            ...
            )
        {
            ...
            // X方向オフセット
            double ofsX = rodDistanceX * 0.5 * latticeCnt;
            // ロッドの半径
            ...
            //const int ndivForOneLattice = 6; // for latticeTheta = 60 r = 0.30a air hole
            ...
            //const int rodRadiusDiv = 3; // for latticeTheta = 60 r = 0.30a air hole
            ...
            Beta1 = 0.0;
            Beta2 = 0.5 * (2.0 * pi / periodicDistance);
            BetaDelta = 0.02 * (2.0 * pi / periodicDistance);
