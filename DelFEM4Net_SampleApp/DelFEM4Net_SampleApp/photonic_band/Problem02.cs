    ...
    class Problem02
    {
            ...
            )
        {
            ...
            using (CCadObj2D cad2d = new CCadObj2D())
            {
                ...
                System.Diagnostics.Debug.Assert(id_v_list_rod_B1.Count == (rodRadiusDiv * 2 + 1));
                System.Diagnostics.Debug.Assert(id_v_list_rod_B2.Count == (rodRadiusDiv * 2 + 1));
                ...
                // 左のロッド
                {
                    ...
                    uint id_v1 = 0;
                    uint id_v2 = 0;
                    int index_v0 = id_v_list_rod_B1.Count - (rodRadiusDiv * 2 + 1);
                    int index_v1 = id_v_list_rod_B1.Count - (rodRadiusDiv + 1);
                    int index_v2 = id_v_list_rod_B1.Count - 1;
